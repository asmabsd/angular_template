...
export class GuideService {
  private apiUrl = 'http://localhost:8089/pidev/Guide/viewGuide';
  private apiUrl2 = 'http://localhost:8089/pidev/Guide/addGuide';
  private apiUrl3 = 'http://localhost:8089/pidev/Guide/updateGuide';
  private apiUrl4 = 'http://localhost:8089/pidev/Guide/getOne';
  constructor(private http: HttpClient) {}
  private apiUrl5 = 'http://localhost:8089/pidev/Guide/deleteGuide';
  ...
  uploadImage(guideId: number, file: File): Observable<string> {
    ...
    return this.http.post<string>(
      `http://localhost:8089/pidev/Guide/${guideId}/uploadImage`,
      formData
    );
  }
  private apiUrl8 = 'http://localhost::8089/pidev/Guide';
